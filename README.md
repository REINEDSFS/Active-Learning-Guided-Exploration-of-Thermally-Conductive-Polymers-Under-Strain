...
- **POLYINFO_PI1M**: A benchmark database for polymer informatics. Refer to the [Polymer embedding tutorial](https://github.com/RUIMINMA1996/polymer_embedding_tutorial) for installation and usage instructions.
...
### LAMMPS Files
- **`amorphous_polymer_P522013.lmps`**: This is a random amorphous polymer LAMMPS data file example generated by [PySimm documentation](https://pysimm.org/) for the amorphous polymer used in simulations.
...
- Use **`lammps-2.in`** to equilibrate the amorphous polymer. Run the following command:
  ...
  ```
### Run the Deformation and NEMD Simulation
